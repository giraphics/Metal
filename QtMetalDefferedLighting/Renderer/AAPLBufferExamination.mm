...
- (void) loadMetalState
{
    ...
    id <MTLLibrary> bufferExaminationLibrary = getLibrary(QString("://Shaders/libs/AAPLBufferExamination.metallib"), _device);
    assert(bufferExaminationLibrary);

    // Set up pipeline to render lightVolumes
    {
        id <MTLFunction> vertexFunction = [bufferExaminationLibrary newFunctionWithName:@"light_volume_visualization_vertex"];
        id <MTLFunction> fragmentFunction = [bufferExaminationLibrary newFunctionWithName:@"light_volume_visualization_fragment"];
    ...
    {
        id <MTLFunction> vertexFunction = [bufferExaminationLibrary newFunctionWithName:@"texture_values_vertex"];
        id <MTLFunction> fragmentFunction = [bufferExaminationLibrary newFunctionWithName:@"texture_rgb_fragment"];
        ...
        fragmentFunction = [bufferExaminationLibrary newFunctionWithName:@"texture_alpha_fragment"];
        renderPipelineDescriptor.fragmentFunction = fragmentFunction;
        ...
        fragmentFunction = [bufferExaminationLibrary newFunctionWithName:@"texture_depth_fragment"];
        renderPipelineDescriptor.fragmentFunction = fragmentFunction;
