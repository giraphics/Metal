...
@property (nonatomic, readonly, nonnull) /*NSArray*/NSMutableArray<id<MTLTexture>> *textures;
...
@property (nonatomic, readonly, nonnull) /*NSArray*/NSMutableArray<AAPLSubmesh*> *submeshes;
