...
- **`MetalCmdlineHelloWorld`**
  <img src="MetalCmdlineHelloWorld/MetalCmdlineHelloWorldOutput.png" width="200"/>
...
- **`MetalCmdlineClearBackground`**
  <img src="MetalCmdlineClearBackground/MetalClearBackgroundOutput.png" width="200"/>
...
- **`MetalFrameBufferCapture`**
  <img src="Capture_MTKVIEW_or_FRAME_BUFFER/MetalFrameBufferReadBackOutput.png" width="200"/>
...
- **`Pixelate`**
  <img src="Pixelate/PixelateOutput.png" width="200"/>
  A Cocoa/Metal application that applies a pixelation effect to an image using a Metal compute kernel. It demonstrates dispatching a GPU compute pass, binding input/output buffers, and reading results back to the CPU for display.
  **You will learn / experiment with:** post‑processing pipelines, compute kernels vs fragment shaders, tuning pixel block size, and how simple math in a compute kernel can dramatically change the visual style.
